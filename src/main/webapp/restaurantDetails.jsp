...
<h1>Restaurant Regitration</h1>
    ...
    <form action="restaurantdetail" method = "post">
            ...
            <div class="details1">
                ...
                <input type="text" name="restaurantname" class="input" pattern="[A-Za-z]{4,}" required><br>

                <label class="label3" for="area">Area</label>
                <input type="text" name="area" class="input" pattern="[0-9A-Za-z]{5,}" required><br>

                <label class="label4" for="city">City</label>
                <input type="text" name="city" class="input" pattern="[A-Za-z]{4,}" required><br>

                <label class="label5" for="pincode">Pincode</label>
                <input type="text" name="pincode" class="input" pattern="[0-9]{6}" required><br>

                <label class="label6" for="landline">Landline Number</label>
                <input type="phone" name="landlineno" class="input" pattern="[1-5]{4}+[5-9]{6}"required><br>

                <label class="label7" for="name">Owner Name</label>
                <input type="text" name="ownername" class="input" pattern="[A-Za-z]{3,}" required><br>
                ...
                <input type="email" name="email" class="input" pattern="[a-z0-9]+[@][a-z]+[.][a-z]+{8,15}" required><br>
                
                <label class="label8" for="password">Password</label>
                <input type="password" name="password" class="input" pattern="[A-Za-z0-9]{8,10}" required><br>
