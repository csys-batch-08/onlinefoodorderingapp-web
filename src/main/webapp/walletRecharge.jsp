...
<form action="rechargewallet" method="post">
         ...
         <input type="text" class="input" id="cardnumber" name="cardnumber" pattern ="[1-9]{16}" required><br><br>
                 
         <label for="cvv">CVV</label><br>
         <input type="text" class="input" id="cvv" name="cvv" pattern="[1-9]{3}" required><br><br>
         
         <label for="Amount">Amount</label><br>
         <input type="text" class="input" id="Amount" name="amount" pattern="[1-9][0-9]+" maxlength="5" required><br><br>
